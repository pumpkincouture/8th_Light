...
attr_reader :board, :comp_winning_combos, :human_winning_combos, :comp_moves, :human_moves
...
def user_turn
  ...
  puts "Please choose a number for your 'O'."
     ...
     #the code below should all be moved into the "else"
     #statement otherwise an accidental move gets pushed
     #to the @human_moves array and is deleted from 
     #@comp_winning_combos
